<div class="side-nav bg-dark ud jsb h-80 w-25 c-w">
    <div class="buttons ud w-100 jcc aic mt-45 p-4">
        ...
        <a href="adminApplications" class="w-100"><button class="btn btn-secondary p-3 my-2 w-100">View Applications</button></a>
    </div>
    <div class="bt h-25">
        <div class="logout w-100 jcc aic p-3">
            <a href="logout"> <button class=" w-100 btn btn-danger">Logout</button></a>
        </div>
        <div class="branding w-100 ">
            <a href="admin_home">
                <img src="images/jobbed_w.png" alt="">
            </a>
            <p class="c-w">©copyright JOBBED 2022</p>
        </div>
    </div>
