...
<body class="bg-man h-100">
    <section class="login ud aic bg-clear h-fit jsb w-100 ">
        ...
        <div class="login-form ud p-4 h-fit jcc aic w-50">
            ...
            <form action="<?php echo base_url('data_handling/worker_register'); ?>" method="POST" enctype="multipart/form-data" class="ud m-0 p-0">
                ...
                <div class="numbers lr p-3 w-100">
                    <div class="phone_no ud w-50 px-2">
                        ...
                        <input type="number" class="form-control" name="phone_number" maxlength="10" id="phone_number">
                    </div>
                    <div class="id_no ud w-50 px-2">
                        <label for="reg_nat_id">National ID no.</label>
                        <input type="number" maxlength="8" class="form-control" name="reg_nat_id" id="reg_nat_id">
                    </div>
                </div>
                ...
                <div class="certs lr w-100 p-3">
                    <div class="conduct ud w-50 px-2">
                        ...
                        <input type="file" name="reg_conduct" id="reg_conduct" class="form-control w-100" accept=".pdf,.doc">
                    </div>
                    <div class="reg_id_photo ud w-50 px-2">
                        <label for="reg_reg_id_photo">Copies of your ID photo:</label>
                        <input type="file" name="reg_id_photo" id="reg_id_photo" class="form-control w-100" accept="image/*">
                    </div>
                </div>
                <div class="expertise ud w-100 p-3">
                    <label for="a-o-ex">Area of expertise</label>
                    <select name="reg_expertise" class="form-control" class="expertise_category" id="reg_expertise">
